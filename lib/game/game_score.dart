                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: new Text('You Got 5 Correct',
                        style: TextStyle(color: Color(0xffffffff),fontSize: 30,fontWeight: FontWeight.w700),),
                    ),
                    Container(
                      alignment: Alignment.topCenter,
                      margin: EdgeInsets.only(top: 10, left: 20, right: 20),
                      child: new Text('Do you want to play the puzzle game again?',
                        style: TextStyle(color: Color(0xffffffff),fontSize: 18,fontWeight: FontWeight.normal),textAlign:TextAlign.center,),
                    ),
                  ],
                ),
                Container(
