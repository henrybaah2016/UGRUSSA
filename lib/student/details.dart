                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'BSc Public Relation & mangt',textAlign: TextAlign.center,
                          ...
                          Padding(
                            ...
                            child: Text(
                              'First Year',textAlign: TextAlign.center,
                              style: TextStyle(color: Color(0xffc8cbcd), fontSize: 16, fontWeight: FontWeight.normal, ),
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: [
                          Container(
                              ...
                              child:Container(
                                width: 55,
                                height: 55,
                                child: Icon(Icons.call, size: 20,color: Color(0xffffffff)),
                          ...
                          Container(
                              ...
                              child:Container(
                                width: 55,
                                height: 55,
                                child: Icon(Icons.mark_chat_unread_sharp, size: 20,color: Color(0xffffffff)),
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: Color(0x31808080)),
                              )
                          ...
                          Container(
                              ...
                              child:Container(
                                width: 55,
                                height: 55,
                                child: Icon(Icons.email_outlined, size: 20,color: Color(0xffffffff)),
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: Color(0x31808080)),
                              )
                          ...
                          Container(
                              ...
                              child:Container(
                                width: 55,
                                height: 55,
                                child: Icon(Icons.cloud_download_outlined, size: 20,color: Color(0xffffffff)),
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: Color(0x31808080)),
                              )
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: Color(0xff8c8c8c), fontSize: 14, fontWeight: FontWeight.normal, ),
                    ),
                  )
                ],
              ),
