                  ...
                  children: <Widget>[
                        ...
                        new Row(
                          ...
                          children: <Widget>[
                            ...
                            new Text(
                              ...
                              style: new TextStyle(color: Color(0xffB3B3B3),fontSize: 11, fontWeight: FontWeight.w600),
                            ),
                            new Text(
                              " agreement ",
                              style: new TextStyle(color: Color(0xff072e79),fontSize: 11, fontWeight: FontWeight.w600),
                            ),
                            new Text(
                              "and i accept it",
                              style: new TextStyle(color: Color(0xffB3B3B3),fontSize: 11, fontWeight: FontWeight.w600),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text('Sign up',style: TextStyle(color: Color(0xffffffff), fontSize: 14, fontWeight: FontWeight.w700,)
                        ),
                      ),
                    ),
                    Container(
